...
test.describe('Loggedin - Navigation', () => {
  ...
  test('Loggedin - Message - Search for message', async ({ page }) => {
    ...
    const message =
      await homePage.header.navigationMenu.navMenuBtnLoggedin.navigateToMessage();
  ...
  test('Loggedin - Wishlists - Get title', async ({ page }) => {
    ...
    const wishlists =
      await homePage.header.navigationMenu.navMenuBtnLoggedin.navigateToWishlist();
  ...
  test('Loggedin - Trips - Get title', async ({ page }) => {
    ...
    const trips =
      await homePage.header.navigationMenu.navMenuBtnLoggedin.navigateToTrips();
  ...
  test('Loggedin - Notifications - Get title', async ({ page }) => {
    ...
    const notifications =
      await homePage.header.navigationMenu.navMenuBtnLoggedin.navigateToNotification();
